...
const RELOADABLE_PATHS = [
  ...
  "daemon.enableNativeSeatRotation",
  "daemon.seatRotationPolicy",
...
const PERSISTED_TO_MUTABLE_PATH = new Map<string, string>([
  ...
  ["daemon.enableNativeSeatRotation", "enableNativeSeatRotation"],
  ["daemon.seatRotationPolicy", "seatRotationPolicy"],
